...
import WAMWebView from './WAMWebViewNativeComponent.ios';
import {
...
const WAMWebViewManager = NativeModules.WAMWebViewManager as ViewManager;
  ...
  (
    ...
    const onShouldStartLoadWithRequestCallback = useCallback(
      (shouldStart: boolean, _url: string, lockIdentifier = 0) => {
        const viewManager = nativeConfig?.viewManager || WAMWebViewManager;
